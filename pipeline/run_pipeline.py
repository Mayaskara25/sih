...
from anomaly.scoring import percentile_normalize, threshold_by_percentile
...
def run_pipeline(*, scene: Path, source: str, detector: str, threshold_pct: float,
                  profile: str, out_dir: Path, normalize_method: str = "standardize") -> dict:
    ...
    score = stage("detector", DETECTORS[detector], norm_cube)
